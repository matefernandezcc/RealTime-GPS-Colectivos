    ...
    try:
        ...
        if(linea_colectivo == "145C"):
            if primer_iteracion:
                ...
                colectivos_en_una_parada = radio_de_llegada(stops_importantes, file_csv)
                ...
                coordenadas_colectivo(1, path_json, listar_parada, id_elegido, ubicaciones_historicas, mapa)
